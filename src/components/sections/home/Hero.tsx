...
const DEFAULT_HERO = {
  badge: 'New: Premium Travel Experiences',
  title: 'Discover the world with',
  titleHighlight: 'Wanderlust Adventures',
  description:
    'Embark on unforgettable journeys to exotic destinations. From the romantic streets of Paris to the mystical pyramids of Egypt, we craft personalized travel experiences that create memories to last a lifetime.',
  features: [
    'Expert local guides',
  ...
  secondaryCTA: 'Watch Travel Stories',
  primaryCTAHref: '#contact',
  secondaryCTAHref: '#demo',
  imageUrl:
    'https://images.unsplash.com/photo-1488646953014-85cb44e25828?q=80&w=1920&auto=format&fit=crop',
  imageAlt: 'Stunning travel destination',
  statsLabel1: 'Destinations',
  statsValue1: '50+ Countries',
  statsLabel2: 'Satisfaction',
  statsValue2: '98% Rating',
} as const;
...
export default function Hero(props: HeroProps) {
  ...
  return (
    <section id="hero" className="relative overflow-hidden bg-background">
      <div className="absolute inset-0 bg-gradient-to-br from-red-500/10 via-yellow-400/5 to-red-600/10" />
      ...
      <div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid items-center gap-12 py-20 sm:py-24 lg:grid-cols-2 lg:gap-20 lg:py-32">
          <div className="flex flex-col justify-center">
            <div className="mb-4 inline-flex w-fit items-center gap-2 rounded-full border border-red-500/20 bg-gradient-to-r from-red-500/10 to-yellow-400/10 px-3 py-1.5 text-sm font-medium text-red-600">
              <span className="inline-block h-2 w-2 rounded-full bg-gradient-to-r from-red-500 to-yellow-400"></span>
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              <Button
                size="lg"
                className="group px-7 text-base bg-gradient-to-r from-red-500 to-yellow-400 hover:from-red-600 hover:to-yellow-500 text-white border-0"
              ...
              <Button
                size="lg"
                variant="outline"
                className="text-base border-red-500/20 text-red-600 hover:bg-red-50 hover:border-red-500/30"
          ...
          <div className="relative">
            ...
            <div className="absolute -right-6 -top-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block">
              ...
              <p className="text-sm">
                <span
                  className="font-semibold bg-gradient-to-r from-red-500 to-yellow-400 bg-clip-text text-transparent"
                  data-editable="statsValue1"
                >
                  {config.statsValue1}
                </span>
              </p>
