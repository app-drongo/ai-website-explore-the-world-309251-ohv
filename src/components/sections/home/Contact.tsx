...
const DEFAULT_CONTACT = {
  badge: 'Contact Us',
  mainTitle: 'Plan Your Dream',
  mainTitleHighlight: 'Adventure',
  mainDescription:
    'Ready to explore the world? Get in touch with our travel experts and let us create the perfect itinerary for your next unforgettable journey.',
  formTitle: 'Start Your Journey',
  formDescription:
    "Tell us about your travel dreams and we'll craft the perfect adventure for you.",
  submitButton: 'Send Travel Inquiry',
  contactSectionTitle: 'Get Travel Assistance',
  method1Title: 'Email Support',
  method1Description: 'Get detailed travel information',
  method1Contact: 'adventures@wanderlust.com',
  ...
  officesSectionTitle: 'Visit Our Offices',
  ...
  office2Address: '456 Medina Quarter, Marrakech',
  ...
  messagePlaceholder:
    'Tell us about your ideal trip - dates, group size, interests, budget range...',
} as const;
...
export default function Contact(props: ContactProps) {
  ...
  return (
    <section
      id="contact"
      className="py-24 bg-gradient-to-b from-red-50/30 via-yellow-50/20 to-background"
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <Badge
            variant="outline"
            className="mb-4 px-4 py-2 border-red-500/20 text-red-600 bg-gradient-to-r from-red-500/10 to-yellow-400/10"
          >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="France">France - Romance & Culture</option>
                    <option value="Morocco">Morocco - Exotic Adventures</option>
                    <option value="Spain">Spain - Vibrant Experiences</option>
                ...
                <Button
                  type="submit"
                  className="w-full text-base py-6 group bg-gradient-to-r from-red-500 to-yellow-400 hover:from-red-600 hover:to-yellow-500 text-white border-0"
                >
          ...
          <div className="space-y-8">
                    ...
                    >
                      <CardContent className="p-6">
                        <div className="flex items-start gap-4">
                          <div className="size-12 rounded-lg bg-gradient-to-r from-red-500/10 to-yellow-400/10 flex items-center justify-center group-hover:from-red-500/20 group-hover:to-yellow-400/20 transition-colors">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                {offices.map((office, index) => (
                  <div
                    key={index}
                    className="p-4 border border-red-500/10 rounded-lg bg-gradient-to-r from-red-50/30 to-yellow-50/20"
                  >
            ...
            <Card className="border-red-500/10">
              <CardContent className="p-6">
                ...
                <div className="mt-4 p-3 bg-gradient-to-r from-red-500/10 to-yellow-400/10 rounded-lg">
