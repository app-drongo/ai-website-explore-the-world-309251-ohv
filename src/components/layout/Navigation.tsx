        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex-shrink-0">
            <Link href="/" className="flex items-center space-x-2">
              <div className="size-8 rounded-lg bg-gradient-to-br from-red-500 to-yellow-500 flex items-center justify-center">
                <span className="text-white font-bold text-sm">{config.logoText.charAt(0)}</span>
              </div>
              <span
                className={cn(
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Button
              size="sm"
              className={cn(
                'group bg-gradient-to-r from-red-500 to-yellow-500 hover:from-red-600 hover:to-yellow-600 text-white',
                config.isTransparent &&
                  !isScrolled &&
                  config.lightText &&
          ...
          >
            ...
            <div className="pt-4 flex flex-col space-y-2">
              <Button
                variant="ghost"
                className={cn(
                  'justify-start hover:text-red-600',
                  config.isTransparent &&
                    !isScrolled &&
                    config.lightText &&
                    'text-white hover:text-white hover:bg-white/10'
              ...
              <Button
                className={cn(
                  'justify-start group bg-gradient-to-r from-red-500 to-yellow-500 hover:from-red-600 hover:to-yellow-600 text-white',
                  config.isTransparent &&
                    !isScrolled &&
                    config.lightText &&
                    'bg-white text-black hover:bg-white/90'
