...
const DEFAULT_FOOTER = {
  logoText: 'WanderLux',
  companyDescription:
    "Discover the world's most breathtaking destinations with our expertly curated travel experiences. From the romantic streets of Paris to the ancient wonders of Egypt, we make your dream journeys unforgettable.",
...
export default function Footer(props: FooterProps) {
  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: 'All Tours', href: '#tours', editableId: 'link-footer-api' },
        { name: 'Custom Trips', href: '#custom', editableId: 'link-footer-documentation' },
      ],
    },
    {
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Safety Guidelines', href: '/safety', editableId: 'link-footer-security' },
        {
          ...
          href: '/cancellation',
          editableId: 'link-footer-compliance',
        },
      ],
    },
  ];
  ...
  return (
    <footer
      id="footer"
      className="bg-gradient-to-br from-red-50 to-yellow-50 border-t border-red-100"
    >
      {/* Main Footer Content */}
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              <Link href="/" className="flex items-center space-x-2 mb-4">
                <div className="size-10 rounded-lg bg-gradient-to-br from-red-500 to-yellow-500 flex items-center justify-center">
                  <span className="text-white font-bold">{config.logoText.charAt(0)}</span>
                </div>
                <span className="font-bold text-xl text-red-700" data-editable="logoText">
                  {config.logoText}
                </span>
              </Link>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                <Mail className="size-4 text-red-500 flex-shrink-0" />
                <span className="text-gray-600" data-editable="contactEmail">
                  {config.contactEmail}
                </span>
              </div>
              <div className="flex items-center gap-3 text-sm">
                <Phone className="size-4 text-red-500 flex-shrink-0" />
                <span className="text-gray-600" data-editable="contactPhone">
                  {config.contactPhone}
                </span>
              </div>
              <div className="flex items-center gap-3 text-sm">
                <MapPin className="size-4 text-red-500 flex-shrink-0" />
                <span className="text-gray-600" data-editable="contactAddress">
            ...
            {/* Newsletter Signup */}
            <div className="space-y-3">
              <h4 className="font-semibold text-sm text-red-700" data-editable="newsletterTitle">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-3 py-2 text-sm border border-red-200 rounded-md bg-white focus:outline-none focus:ring-2 focus:ring-red-500/20 focus:border-red-500"
                />
                <Button
                  size="sm"
                  className="px-3 bg-gradient-to-r from-red-500 to-yellow-500 hover:from-red-600 hover:to-yellow-600 text-white"
                >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              <span className="text-sm text-gray-600 mr-2" data-editable="socialText">
                {config.socialText}
              </span>
              {socialLinks.map((social, index) => {
                ...
                return (
                  <Link
                    ...
                    className="size-8 rounded-md bg-white hover:bg-red-100 flex items-center justify-center transition-colors duration-200 group border border-red-100"
                    data-editable-href={`social${index + 1}Href`}
                    data-original-href={social.href}
                  >
                    <Icon className="size-4 text-gray-600 group-hover:text-red-500 transition-colors" />
                  </Link>
                );
              })}
            </div>
          ...
          {/* Additional Links */}
          <div className="flex flex-wrap justify-center md:justify-start gap-6 mt-4 pt-4 border-t border-red-200/50">
